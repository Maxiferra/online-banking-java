            ...
            <div class="card-body">
                <form action="ServletTransferir" method="post" id="transferenciaForm">
                    ...
                    <div class="form-group">
                        <label>¿A quién querés transferir?</label>
                        <input type="text" id="txtCuentaDestino" name="txtCuentaDestino" class="form-control" placeholder="Ingrese CBU destino">
                    </div>
                    <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="txttipotransferencia" name="txttipotransferencia" value="1">
