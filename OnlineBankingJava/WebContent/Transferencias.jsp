    ...
    <div class="postbody">
        <div class="card">
            ...
            <div class="card-body">
			        ...
			        %>
            <form action="ServletTransferenciaPropia" method="post" id="transferenciaPropiaForm">
             	<button type="submit" class="btn btn-primary fw-bold fs-5">Transferencias Propias</button>
             </form> 
             <form action="ServletTransferenciaTerceros" method="post" id="transferenciaTercerosForm">
             	<button type="submit" class="btn btn-primary fw-bold fs-5">Transferencias a Terceros</button>  
            </form> 
            </div>
        </div>
    </div>
